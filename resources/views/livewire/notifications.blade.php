...
<div>
    <div class="p-4 sm:ml-64">
        <div class="p-4 mt-16">
            ...
            <!-- Today Notifications -->
            <div class="font-semibold text-lg text-black leading-right flex font-['Inter']">Today</div>
            <div class="w-full bg-white sm:rounded-lg md:mb-6 ">
                <div x-data="{ 
                    tableItems: [
            ...
            <div class="font-semibold text-lg text-black leading-right flex font-['Inter']">Yesterday</div>
            <div class="w-full bg-white sm:rounded-lg md:mb-0">
                <div x-data="{ 
                    tableItems: [
                            { date: '00/00/0000', 'time': '00:00:00', 'status': 'Regular text column' },
                            { date: '00/00/0000', 'time': '00:00:00', 'status': 'Regular text column' },
