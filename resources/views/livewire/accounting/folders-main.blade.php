        ...
        <div class="p-4 mt-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                @foreach ($ap_folders as $folder)
                    <a href="/folders/yearly" class="flex flex-col items-start justify-center bg-white border border-gray-200 rounded h-14 text-[#6B6C7E] hover:text-blue-800 active:text-cyan-700 rounded-md hover:shadow">
