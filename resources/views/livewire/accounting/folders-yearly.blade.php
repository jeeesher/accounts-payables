    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 mt-16">
            ...
            <div class="mt-4 flex items-center justify-between">
                <div class="font-semibold text-2xl text-black dark:text-gray-200 leading-right flex font-['Inter']">Folders: 2022-2023 </div>
            ...
            <div class="w-full bg-white dark:bg-gray-800 sm:rounded-lg md:mb-0">
                ...
                <div>
                    <div class="flex flex-wrap w-full mx-auto">
                        <div class="pr-4 mt-3 lg:w-1/3">
                            <div class="relative h-full pt-2 pb-2 text-left">

                            @php
                            $payable = DB::table('ap_files')
                                ...
                                <div class="mb-4">  
                                    <div class="inline-flex items-center justify-start w-full gap-2 px-3 py-6 bg-white border border-gray-200 rounded-md shadow h-9">
                                        <div class="flex items-center justify-start h-5 gap-2 grow shrink basis-0">
                                            <div class="ml-2 grow shrink basis-0 text-950 text-sm font-medium font-['Inter'] leading-tight">{{ $pay->BUR }}</div>
                                        </div>
                                        <!-- Dropdown -->
                            ...
                            @endforeach
                                ...
                                <div class="mb-4">  
                                    <div class="inline-flex items-center justify-start w-full gap-2 px-3 py-6 bg-white border border-gray-200 rounded-md shadow h-9">
                                        <div class="flex items-center justify-start h-5 gap-2 grow shrink basis-0">
                                            <div class="ml-2 grow shrink basis-0 text-950 text-sm font-medium font-['Inter'] leading-tight">BUR Number</div>
                                        </div>
                                        <!-- Dropdown -->
                                        <x-folders-action-yearly />
                                    </div>
                ...
                <!-- Pagination -->
                <nav class="flex items-center flex-column flex-wrap md:flex-row justify-between pt-3 font-['Inter']" aria-label="Table navigation">
