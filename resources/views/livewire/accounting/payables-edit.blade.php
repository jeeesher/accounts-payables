    ...
    <div class="p-4 sm:ml-64">
        <form class="p-4 mt-16" enctype="multipart/form-data" action="{{ route('update.payable') }}" method="POST">
            ...
            <div class="mt-4 mb-4 flex items-center justify-between">
                <div class="font-semibold text-2xl text-black leading-right flex font-['Inter']">Edit Payable</div>

                <!-- Button Group -->
                <div class="flex space gap-1">
                    <!-- Delete Button -->
                    <a href="{{ route('delete.payable', ['iden' => $payable->BUR]) }}" onclick="return confirmDeletePayable()" class="inline-flex items-center text-zinc-950 text-sm font-medium font-['Inter'] bg-white border border-zinc-200 shadow hover:bg-blue-800 hover:text-white focus:ring-2 focus:ring-blue-200 rounded-lg text-sm px-4 py-2 me-2 mb-2 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 active:bg-cyan-700">
            ...
            <div class="max-w-10xl mx-auto space-y-6 flex">
                <!-- Edit Payables Form -->
                <div class="bg-white sm:rounded-lg lg:max-w-lg lg:w-1/3 md:w-1/2 w-full mb-10 md:mb-0">
                    <!-- Payable Information Input Field -->
                    <div>
                        <div class="font-semibold text-lg text-black leading-right flex font-['Inter']">Payable Information</div>

                        <div class="mx-auto mt-5 font-['Inter']">
                            <!-- BUR Input Field -->
                            <div class="mb-4">
                                <div class="flex items-center">
                                    <label for="BUR" class="block mb-2 text-sm font-medium text-black">BUR Number</label>
                                </div>
                                <input type="text" id="BUR" name="BUR" class="bg-zinc-100 border-black text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 border-black dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $payable -> BUR }}" required/>
                            ...
                            <div class="mb-4">
                                <div class="flex items-center">
                                    <label for="EndUser" class="block mb-2 text-sm font-medium text-black">End-user</label>
                                    <span class="text-red-500 p-1 pl-3">*</span>
                                </div>
                                <input type="text" id="EndUser" name="EndUser" class="bg-zinc-100 border-black text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 border-black dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $payable -> EndUser }}" required />
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="Amount" name="Amount" class="bg-zinc-100 border-black text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 border-black dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $payable -> Amount }}" required />
                            ...
                            <div class="mb-4">
                                <div class="flex items-center">
                                    <label for="TermsPayment" class="block mb-2 text-sm font-medium text-black">Terms of Payment</label>
                                    <span class="text-red-500 p-1 pl-3">*</span>
                                </div>
                                <input type="text" id="TermsPayment" name="TermsPayment" class="bg-zinc-100 border-black text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 border-black dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ $payable -> TermsPayment }}" required/>
                    ...
                    <div class="pt-5">
                        <div class="font-semibold text-lg text-black leading-right flex font-['Inter']">Supplier Information</div>

                        <div class="mx-auto mt-5 font-['Inter']">
                            <!-- Supplier Name Dropdown Field -->
                            <div class="mb-4">
                                <div class="flex items-center">
                                    <label for="suplier_name" class="block mb-2 text-sm font-medium text-black">Supplier Name</label>
                                    <span class="text-red-500 p-1 pl-3">*</span>
                                </div>
                                <select id="SupplierName" name="SupplierName" wire:model="supplier_id" class="bg-zinc-100 border-black text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 border-black dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" required/>
                            ...
                            <div class="mb-4">
                                <div class="flex items-center">
                                    <label for="SupplierAdd" class="block mb-2 text-sm font-medium text-black">Supplier Address</label>
                                    <span class="text-red-500 p-1 pl-3">*</span>
                                </div>
                            ...
                            <div class="mb-4">
                                <div class="flex items-center">
                                    <label for="SupplierContact" class="block mb-2 text-sm font-medium text-black">Supplier Contact Number</label>
                                    <span class="text-red-500 p-1 pl-3">*</span>
                                </div>
                ...
                <div class="bg-white sm:rounded-lg flex-grow -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center" style="align-self: flex-start; margin-top: 0; padding-top: 0;">
                    <!-- Particular Field -->
                    <div class="mb-5 w-ful">
                        <div class="flex items-center mb-3">
                            <div class="font-semibold text-lg text-black leading-right flex font-['Inter']">Particular</div>
                        ...
                        <div class="mt-4 flex justify-end w-full">
                            ...
                            <button x-data x-on:click="$dispatch('open-add-new-particular')" type="button" class="ml-4 inline-flex items-center text-white text-sm font-medium font-['Inter'] bg-zinc-100 hover:bg-blue-800 hover:text-white focus:ring-2 focus:ring-blue-200 rounded-lg text-sm px-4 py-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 active:bg-cyan-700">
                                <svg class="me-2 mb-0.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    ...
                    <div class="flex flex-col">
                        <div class="font-semibold text-lg text-black leading-right flex font-['Inter']">Disbursement Voucher Preview</div>
                        ...
                        <div class="flex justify-end">
                            ...
                            <label for="DV-file-upload" class="custom-file-upload-button inline-flex items-center text-white text-sm font-medium font-['Inter'] bg-white hover:bg-blue-800 hover:text-white focus:ring-2 focus:ring-blue-200 rounded-lg text-sm px-4 py-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 active:bg-cyan-700">
                                <svg class="me-2 mb-0.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
