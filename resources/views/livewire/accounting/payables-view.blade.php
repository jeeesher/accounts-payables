    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 mt-20">
            ...
            <div class="mb-4 flex items-center justify-between">
                <div class="font-semibold text-2xl text-black leading-right flex font-['Inter']">View Payable</div>
                
                <!-- Button Group -->
                <div class="flex space gap-1">
                    <!-- Delete Button -->
                    <a href="{{ route('delete.payable', ['iden' => $payable->BUR]) }}" onclick="return confirmDeletePayable()" class="inline-flex items-center text-white text-sm font-medium font-['Inter'] bg-white border border-zinc-200 shadow hover:bg-blue-800 hover:text-white focus:ring-2 focus:ring-blue-200 rounded-lg text-sm px-4 py-2 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 active:bg-cyan-700">
                    ...
                    <!-- Edit Button -->
                    <a href="{{ url('/payables/edit?payable=' . $payable -> BUR)}}" type="button" class="inline-flex items-center text-white text-sm font-medium font-['Inter'] bg-white border border-zinc-200 shadow hover:bg-blue-800 hover:text-white focus:ring-2 focus:ring-blue-200 rounded-lg text-sm px-4 py-2 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 active:bg-cyan-700">
                        <svg class="me-2 mb-0.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    ...
                    <button type="button" class="inline-flex items-center text-white text-sm font-medium font-['Inter'] bg-white border border-zinc-200 shadow hover:bg-blue-800 hover:text-white focus:ring-2 focus:ring-blue-200 rounded-lg text-sm px-4 py-2 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 active:bg-cyan-700">
                        <svg class="me-2 mb-0.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    ...
                    <a href="{{ url('/tracking/view?payable=' . $payable -> BUR)}}" type="button" class="inline-flex items-center text-white text-sm font-medium font-['Inter'] bg-indigo-50 shadow border border-zinc-200 hover:bg-blue-800 hover:text-white focus:ring-2 focus:ring-blue-200 rounded-lg text-sm px-4 py-2 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 active:bg-cyan-700">
                        <svg class="me-2 mb-0.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
            ...
            <div class="bg-white sm:rounded-lg ">
                ...
                <div class="mb-6">
                    <div class="mb-3 font-semibold text-lg text-black leading-right flex font-['Inter']">Supplier Information</div>
                    <div class="flex flex-wrap w-full mx-auto">
            ...
            <div class="bg-white sm:rounded-lg w-full mb-5 md:mb-0 pr-3">
                <!-- Particular and Payable View Section -->
                <div class="bg-white sm:rounded-lg mx-auto flex sm:flex-nowrap flex-wrap">
                    <!-- Particular Section -->
