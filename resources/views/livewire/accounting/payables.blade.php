        ...
        <div class="p-4 sm:ml-64">
            <div class="p-4 mt-20">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <div class="font-semibold text-2xl text-black leading-right flex font-['Inter']">Payables</div>
