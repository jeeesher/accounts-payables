            ...
            <div class="mt-4 max-w-10xl mx-auto space-y-6 flex">
                ...
                <div class="bg-white  sm:rounded-lg lg:max-w-lg lg:w-1/3 md:w-1/2 w-full mb-10 md:mb-0">
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-between mb-4 pt-3">
                            <div class="font-semibold text-xl text-black  leading-right flex font-['Inter']">Payable Information</div>
                            
                            <!-- View Payable Button -->
                            <a href="{{ url('/payables/view?payable=' . $payable -> BUR)}}" type="button" class="mb-1 flex items-center justify-between font-medium text-xs text-indigo-800 leading-right flex font-['Inter'] hover:text-black active:text-cyan-700">
                                View Payable
                            </a>
                        </div>
                ...
                <div class="bg-white sm:rounded-lg flex-grow -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center" style="align-self: flex-start; margin-top: 0; padding-top: 0;">
                    ...
                    <div class="mb-5 flex items-center justify-between">
                        <div class="font-semibold text-xl text-black leading-right flex font-['Inter']">Payable Tracking</div>
                        ...
                        <div class="flex gap-1 space">
                            ...
                            <div x-data = "{ show: false}" x-show = "show" x-on:open-edit-track.window="show = true"
                                ...
                                @csrf
                                    <div class="pb-5 font-semibold text-lg text-black leading-right flex">Edit Track</div>
