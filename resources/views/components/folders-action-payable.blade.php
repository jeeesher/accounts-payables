<div class="flex justify-center">
    <div
        ...
        x-id="['dropdown-folders-action-payable']"
    ...
    >
        ...
        <button
            ...
            x-on:click="toggle()"
            :aria-expanded="open"
            :aria-controls="$id('dropdown-folders-action-payable')"
            type="button"
        ...
        <div
            ...
            :id="$id('dropdown-folders-action-payable')"
            style="display: none;"
        ...
        >  
            ...
            <x-delete-file />
            <button x-data x-on:click="$dispatch('open-delete-file')" class="flex items-center justify-between gap-2 w-full first-of-type:rounded-t-md last-of-type:rounded-b-md px-4 py-2.5 text-left text-sm hover:bg-gray-50 disabled:text-gray-500">
                Delete
            </button>
        </div>
    </div>
