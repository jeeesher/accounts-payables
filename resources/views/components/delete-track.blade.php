<div 
    x-data = "{ show: false}" 
    x-show = "show"
    x-on:open-delete-track.window="show = true"
    x-on:close-delete-track.window="show = false"
    style="display: none;"
    ...
    <div class="fixed inset-0 bg-white rounded-md p-6 m-auto w-auto h-48 max-w-md font-['Inter'] overflow-y-auto">
        <div class="pb-4 font-semibold text-lg text-black dark:text-gray-200 leading-right flex">Are you sure you want to delete this track?</div>

        <div class="pb-2 text-zinc-500 text-sm font-normal font-['Inter'] leading-tight">This action cannot be undone. This will permanently delete the payable track and remove the data from our records. </div>
