<div class="flex justify-center">
    ...
    >
        ...
        <button
            ...
            type="button"
            class="flex items-center gap-2 bg-white px-5 py-2.5 text-sm leading-4 font-medium font-['Inter'] dark:focus:ring-gray-600 text-gray-500 dark:text-gray-400 dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300"
        >
            ...
            Mara Calinao <!-- should be the name of the user || Auth::user()->name if getting the name from the db record -->                                   
        ...
        <div
            ...
            :id="$id('dropdown-menu')"
            style="display: none;"
            class="absolute left-0 mt-1 w-40 rounded-md bg-white shadow-md font-['Inter']"
        >  
