<div class="flex justify-center">
    ...
    >
        ...
        <button
            ...
            type="button"
            class="flex items-center gap-2 bg-white px-5 py-1.5 text-sm leading-4 font-medium font-['Inter'] dark:focus:ring-gray-600 text-black dark:text-gray-400 hover:text-black dark:hover:text-black"
        >
            ...
            <div class="flex flex-col items-start font-['Inter']">
                <div class="text-black-90 text-sm font-semibold">Mara Calinao</div>
                <div class="text-black-90 text-xs"> Accounting Officer </div>
            </div>
